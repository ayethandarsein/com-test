...
public class ReportGraphMB implements Serializable {
    ...
    public void init() {
        try {
            reportGraphParentList = new ArrayList<ReportGraphDTOParent>();
                ...
                if (fromToAllPeriod.size() > 12) {
                    ...
                    if (reportGraphList.size() > 0) {
                        ...
                        createBarModel();
                         ...
                         MessagesView.info("There is no data!");
                        flag = false;
                    }
                }
            }
    ...
    private void createLineModels() {
        ...
        lineModelForNoofPlant.setDatatipFormat("%2$.0f");
        ...
        lineModelForNoofTruck.setDatatipFormat("%2$.0f");
    ...
    private void createBarModel() {
        ...
        barModelForTruckCapacity.setDatatipFormat("%2$.0f");
        ...
        barModelForVolumepermonth.setDatatipFormat("%2$.0f");
