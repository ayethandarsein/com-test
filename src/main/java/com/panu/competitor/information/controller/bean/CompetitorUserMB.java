...
public class CompetitorUserMB implements Serializable {
    ...
    private String roleRequiredMessage = MessagesCommon.M0054_ROLE_REQUIRED;
    Date date = new Date();
    ...
    public String getRoleRequiredMessage() {
        return roleRequiredMessage;
    }

    public void setRoleRequiredMessage(String roleRequiredMessage) {
        this.roleRequiredMessage = roleRequiredMessage;
    }
